...
- Network access to `/oauth2/*` and `/api/oauth2/*` paths should follow the same TLS and WAF rules as the rest of the API.
...
```python title="cadence/api/admin_security.py"
