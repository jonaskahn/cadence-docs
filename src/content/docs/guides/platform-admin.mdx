...
| `GET`  | `/api/admin/pool/stats` | `cadence:system:telemetry:read` | Pool statistics: total instances, tier counts (hot/warm/cold), shared model and bundle counts, memory estimate     |
