...
| Variable                       | Default           | Purpose                                                    |
| ------------------------------ | ----------------- | ---------------------------------------------------------- |
| `CADENCE_S3_ENABLED`           | `true`            | Enable S3/MinIO as the plugin binary store                 |
...
| `CADENCE_CONSENT_UI_URL`                                                                       | `{oauth_redirect_base_url}/oauth/consent` | Full URL to the consent UI page              |
...
| `CADENCE_LOG_FORMAT`  | `text`       | Set to `json` for structured log output                         |
