...
**API validation** (`FRAMEWORK_SUPPORTED_MODES` in `cadence/core/constants/framework.py`) must allow the framework + mode pair at create time — see [Orchestration backends](/features/orchestration-backends/).
